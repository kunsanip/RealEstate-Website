 ...
 * @author Sanip
 */
public class DismissOwnerMessage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String ownerMessageID = (String) request.getParameter("ownerMessageID");
            ...
            String sql = "DELETE FROM ownerMessages WHERE ownerMessageID = '" + ownerMessageID + "'";
