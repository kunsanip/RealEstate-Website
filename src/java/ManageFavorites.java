 ...
 * @author Sanip
 */
public class ManageFavorites extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String favorite = (String) request.getParameter("favorite");
        String from = (String) request.getParameter("from");

        switch (favorite) {
            case "add":
                favoritesList.add(propertyID);
                break;
            case "remove":
                favoritesList.remove(propertyID);
                break;
        }
