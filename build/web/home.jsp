...
<%
    ...
    String errAdminID = (String) session.getAttribute("errAdminID");
    String errAdminPassword = (String) session.getAttribute("errAdminPassword");
    ...
    String adminSignInError = (String) session.getAttribute("adminSignInError");
...
<html lang="en">
    ...
    <head>
        ...
        <script>
            var adminSignInError = "<%=adminSignInError%>";
            if (adminSignInError == "true") {
                $(function () {
                    $('#adminSignIn').modal();
                });
            }
    ...
    <body>
            ...
            <nav class="navbar navbar-default" style="background: #505585">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <form class="navbar-form navbar-left" action="servlet/SearchProperties" method="post">
                            <input type="text" class="form-control" name="searchCriteria"
                                   style="width: 300px" placeholder="Enter any keyword...">
                            &nbsp;&nbsp;<button class="btn btn-warning" type="submit" name="search" value="search">
                            <span class="glyphicon glyphicon-search"></span></button>
                        </form>
                    <div class="navbar-form navbar-left" action="">
                        <a class="btn btn-link" style="color: white" href="search.jsp">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body ">
                            <div class="row">
                                ...
                                <div class="col-xs-7">
                                    <form class="form-inline"  action="servlet/BrowseProperties" method="post">
                                        <select class="form-control" name="adPurpose" style="width: 100px">
                                            <option value="For%">Ad Type</option>
                                            <option value="For%">Any</option>
                                            <option value="For sale">For sale</option>
                                            <option value="For rent">For rent</option>
                                        </select>
                                        &nbsp;
                                        <select class="form-control" name="propertySuburb" style="width: 200px">
                                            <option value="%%">Suburb</option>
                                            <option value="%%">Any</option>
                                            <%for (int i = 0; i < suburbsList.size(); i++) {%>
                                            <option value="<%=suburbsList.get(i)%>">
                                                <%=suburbsList.get(i)%></option>
                                            <%}%>
                                        </select>
                                        &nbsp;
                                        <input type="submit" class="btn btn-warning" name="browseSubmit" value="Go"/>
                                    </form>
                                </div>
                            </div>
                        </div>                    
                       ...
                       <!-- Left Panel -->
                        ...
                        <div class="col-md-6">
                            ...
                            <p>
                                ...
                                <img src="images/parking_spaces.png" title="Car spaces"/>
                            ...
                            <div class="pull-right">
                                ...
                                <div class="btn-group">
                                    ...
                                    <a class="btn btn-lg btn-default"
                                       href="servlet/ManageFavorites?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/index.jsp&favorite=remove"
                                    ...
                                    <%}else{%>
                                    <a class="btn btn-lg btn-default"
                                       href="servlet/ManageFavorites?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/index.jsp&favorite=add"
                                    ...
                                    <%if(comparator){%>
                                    <a class="btn btn-lg btn-default"
                                       href="servlet/ManageComparisonList?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/index.jsp&comparator=remove"
                                    ...
                                    <%}else{%>
                                    <a class="btn btn-lg btn-default"
                                       href="servlet/ManageComparisonList?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/index.jsp&comparator=add"
                                        ...
                                        <div class="caption">
                                            ...
                                            <div class="btn-group pull-right">
                                                ...
                                                <button type="button" class="btn btn-link" data-toggle="modal"
                                                    ...
                                                    <span class="glyphicon glyphicon-envelope" data-toggle="tooltip"
                                                        data-placement="bottom"title="Contact owner"></span>
                                                </button>
                                            </div>
                                            <br/>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                    <a class="btn btn-link" style="color: whitesmoke; font-size: 12px;"
                                       href="index.jsp">Privacy Policy</a>
                                </div>
                                <div class="btn-group">
                                    <a class="btn btn-link" style="color: whitesmoke; font-size: 12px;"
                                       href="index.jsp">Conditions of use</a>
                                </div>
                                <div class="btn-group">
                                    <a class="btn btn-link" style="color: whitesmoke; font-size: 12px;"
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-link" style="color: whitesmoke; font-size: 12px;"
                                       data-toggle="modal" data-target="#adminSignIn">Admin Dashboard</a>
                                </div>
                            </div>
        ...
        <!--Admin Sign in Modal-->
        <div class="modal" id="adminSignIn" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" style="margin-top: 10%">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Admin Sign in</h4>
                    </div>
                    <form action="servlet/AdminSignIn" method="post" id="AdminSignIn">
                        <div class="modal-body">
                            <input type="text" class="form-control" id="adminID" name="adminID" placeholder="Username"
                                   <%if (adminID != null) {%> value="<%=adminID%>" <%}%>/>
                            <%if (errAdminID != null) {%>  <small> <%=errAdminID%> </small> <%}%>
                            <br/>
                            <input type="password" class="form-control" id="adminPassword" name="adminPassword" placeholder="Password"/>
                            <%if (errAdminPassword != null) {%>  <small> <%=errAdminPassword%> </small> <%}%>
                        </div>
                        <div class="modal-footer">
                            <div class="btn-group btn-group-sm">
                                <input type="submit" class="btn btn-default" id="adminSignInCancel" name="adminSignInCancel" value="Cancel"/>
                                <input type="submit" class="btn btn-primary" id="adminSignInSubmit" name="adminSignInSubmit" value="Submit"/>
                            </div>
                        </div>
                    </form>
                </div>
