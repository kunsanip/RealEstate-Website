...
<%
    ...
    String adPurpose = (String) session.getAttribute("adPurpose");
    String propertySuburb = (String) session.getAttribute("propertySuburb");
    if(propertySuburb.equals("%%")){propertySuburb = "any suburb";}
    ...
    <body>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-default" style="background: #505585">
                <div class="container-fluid">
                    ...
                    <div class="navbar-form navbar-left" action="">
                        <a class="btn btn-link" style="color: white" href="servlet/SearchProperties">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> Browse Properties </li>
            </ol>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                                ...
                                <div class="col-xs-7">
                                    <form class="form-inline"  action="servlet/BrowseProperties" method="post">
                                        <select class="form-control" name="adPurpose" style="width: 100px">
                                            ...
                                            <option value="For%" <%if (adPurpose != null) {
                                                    if (adPurpose.equals("For%")) {%> <%="selected"%> <%}}%>
                                                >Any</option>
                                            <option value="For sale" <%if (adPurpose != null) {
                                                    if (adPurpose.equals("For sale")) {%> <%="selected"%> <%}}%>
                                                >For sale</option>
                                            <option value="For rent" <%if (adPurpose != null) {
                                                    if (adPurpose.equals("For rent")) {%> <%="selected"%> <%}}%>
                                                >For rent</option>
                                        </select>
                                        &nbsp;
                                        <select class="form-control" name="propertySuburb" style="width: 200px">
                                            <option value="%%">Suburb</option>
                                            <option value="%%" <%if (propertySuburb != null) {
                                                    if (propertySuburb.equals("any suburb")) {%> <%="selected"%> <%}}%>
                                                >Any</option>
                                            <%for (int i = 0; i < suburbsList.size(); i++) {%>
                                            <option value="<%=suburbsList.get(i)%>"<%if (propertySuburb != null) {
                                                    if (propertySuburb.equals(suburbsList.get(i))) {%> <%="selected"%> <%}}%>
                    ...
                    <div class="page-header">
                        <h3>Showing properties in <%=propertySuburb%></h3>
                    </div>                    
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="btn-group">
                                ...
                                <a class="btn btn-lg btn-default"
                                   href="servlet/ManageFavorites?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/servlet/BrowseProperties&favorite=remove"
                                ...
                                <%}else{%>
                                <a class="btn btn-lg btn-default"
                                   href="servlet/ManageFavorites?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/servlet/BrowseProperties&favorite=add"
                                ...
                                <%if(comparator){%>
                                <a class="btn btn-lg btn-default"
                                   href="servlet/ManageComparisonList?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/servlet/BrowseProperties&comparator=remove"
                                ...
                                <%}else{%>
                                <a class="btn btn-lg btn-default"
                                   href="servlet/ManageComparisonList?propertyID=<%=(propertiesList.get(i)).getPropertyID()%>&from=/servlet/BrowseProperties&comparator=add"
